...
You now want to acquire the Micro SD card associated with your printer and plug it into the computer using the 
USB A adapter. Now click “Save Toolpaths to Disk” and transfer the SD card to the printer (via left side hole).
...
When the printer is on, this should be the home page. Click the wheel and scroll to the bottom where it 
says, “Print from media”. Select the file you saved to the SD card and select print.

*Picture*

If everything is okay, your model should print. It is a good idea to check on your print periodically to make sure nothing 
is going wrong. If you need to stop the print for whatever reason, click the button and scroll to “Stop Print”. A Successful 
...
.. figure:: ../_static/images/Eryone23.PNG
    :figwidth: 150px
    :target: ../_static/images/Eryone23.PNG
...
>>>>>>> 21562404a919dc0d2ae6decbe886a28095d041c7
